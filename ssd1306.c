 ...
 * adapted for project^ AlexPrime alex.mail.prime@gmail.com
...
// SSD1306 data buffer
static uint8_t SSD1306_Buffer[SSD1306_WIDTH * SSD1306_HEIGHT / 8] = {0};//add data buffer and fil it zero {0}
...
OLED_Connect_Status SSD1306_Init(I2C_Connection *_i2c) {
	if (_i2c->i2cStatus == I2C_Bus_Free) {//send SSD1306_oled initial string commands
		...
		case 15:
			...
			_i2c->rxtxp = &SSD1306_Buffer[SSD1306_WIDTH * (SSD1306_CommandDraw[0] - 0xB0)];
